    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar d-flex flex-column align-items-center">
            ...
            <nav class="nav flex-column w-100">
                ...
                <a class="nav-link active mb-2" href="product_dashboard.php">Product Dashboard</a>
        ...
        <div class="col-md-7 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                <h2 class="mb-0 text-white">🛍️ Products Dashboard</h2>
                ...
                <table class="table table-bordered table-hover shadow-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['image']): ?>
                                    <img src="uploads/<?= $row['image'] ?>" width="60" class="img-thumbnail">
                                <?php else: ?>
                                    <span class="text-muted">No image</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <a href="edit_product.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary mb-1">Edit</a>
                                <a href="delete_product.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger mb-1"
